...
from queries import os_saida_query
from dominios.db import OSSaida
...
class OsSaidaRepositorio():
    ...
    def nova_os(self, id_cliente, os, sessao):
        ...
        nova_os = OSSaida(equipamento=os.equipamento, marca=os.marca, modelo=os.modelo, acessorios=os.acessorios,
                          ...
                          operador=os.operador, operador_entrada=os.opEntrada, log=os.log, codigo1=os.codigo1,
                          codigo2=os.codigo2, codigo3=os.codigo3,
                          codigo4=os.codigo4, codigo5=os.codigo5, codigo6=os.codigo6, codigo7=os.codigo7,
                          codigo8=os.codigo8,
                          codigo9=os.codigo9, desc_serv1=os.desc_serv1, desc_serv2=os.desc_serv2,
                          desc_serv3=os.desc_serv3,
                          desc_serv4=os.desc_serv4, desc_serv5=os.desc_serv5, desc_serv6=os.desc_serv6,
                          desc_serv7=os.desc_serv7, desc_serv8=os.desc_serv8, desc_serv9=os.desc_serv9,
                          desconto=os.desconto,
                          obs1=os.obs1, obs2=os.obs2, obs3=os.obs3, valor_mao_obra=os.valor_mao_obra, qtd1=os.qtd1,
                          qtd2=os.qtd2, qtd3=os.qtd3, qtd4=os.qtd4, qtd5=os.qtd5, qtd6=os.qtd6, qtd7=os.qtd7,
                          qtd8=os.qtd8,
                          ...
                          obs_pagamento3=os.obsPagamento3, data_garantia=os.dataGarantia, notaFiscal=0,
                          cliente_saida=cliente,

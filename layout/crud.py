...
class Castelo:
    ...
    def janelaAbrirOs(self):
        ...
        def manAnteriores():
            ...
            if len(oss) == 0:
                ...
                tree_ap_entr.heading('dias', text='DIAS')
                ...
                tree_ap_entr.heading('data_orc', text='DATA ORÇAMENTO')
    ...
    def janelaOrçamento(self, jan):
        ...
        Button(botoes_os, text="Confirmar Saída", wraplength=70, width=15, height=2,
               command=lambda: [self.editar_orc(jan, jan1, 3)]).pack(side=LEFT, padx=20)
    ...
    def abreJanelaConfigurações(self):
        ...
        def popularOperador():
            ...
            for i in conf_operador:
                tree_conf_op.insert('', 'end',
                                    values=(i.nome, 'SIM', 'SIM', 'SIM', 'SIM', 'SIM', 'SIM', 'SIM'))
        ...
        def janelaExcluiOperador():
            ...
            button_cancelar = Button(subframe2_exclui_op, text='Cancelar', width=10)
            button_cancelar.pack(side=RIGHT, ipady=5)
            button_excluir = Button(subframe2_exclui_op, text='Excluir', width=10)

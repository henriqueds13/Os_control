...
from entidades import cliente, os, os_saida, produto, revendedor, estoque, produto_venda, os_venda, empresa, tecnico, \
    livro_caixa, op_livro_caixa, contas, calevent, aluguel, maquina_aluguel, acessorios_aluguel
...
from repositorios import cliente_repositorio, os_repositorio, os_saida_repositorio, produto_repositorio, \
    ...
    aluguel_repositorio, maquina_aluguel_repositorio, acessorio_maquina_aluguel_repositorio
...
class Castelo:
    ...
    def __init__(self, master, sessao):
        ...
        self.label_num_alug = Label(self.frame_num_alug, text=0, fg='#ffff80', font='bold', bg=color_orc2)
        ...
        self.quant_entry2 = Entry(self.subframe_material1, width=5, relief=RIDGE, state=DISABLED)
        self.quant_entry2.grid(row=1, column=0, padx=5)
        self.id_entry2 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.id_entry2.grid(row=1, column=1)
        self.descr_entry2 = Entry(self.subframe_material1, width=50, relief=RIDGE, state=DISABLED)
        self.descr_entry2.grid(row=1, column=2, padx=5)
        self.val_uni_entry2 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.val_uni_entry2.grid(row=1, column=3)
        self.val_total_entry2 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.val_total_entry2.grid(row=1, column=4, padx=5)
        self.quant_entry3 = Entry(self.subframe_material1, width=5, relief=RIDGE, state=DISABLED)
        self.quant_entry3.grid(row=2, column=0, padx=5)
        self.id_entry3 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.id_entry3.grid(row=2, column=1)
        self.descr_entry3 = Entry(self.subframe_material1, width=50, relief=RIDGE, state=DISABLED)
        self.descr_entry3.grid(row=2, column=2, padx=5)
        self.val_uni_entry3 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.val_uni_entry3.grid(row=2, column=3)
        self.val_total_entry3 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.val_total_entry3.grid(row=2, column=4, padx=5)
        self.quant_entry4 = Entry(self.subframe_material1, width=5, relief=RIDGE, state=DISABLED)
        self.quant_entry4.grid(row=3, column=0, padx=5)
        self.id_entry4 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.id_entry4.grid(row=3, column=1)
        self.descr_entry4 = Entry(self.subframe_material1, width=50, relief=RIDGE, state=DISABLED)
        self.descr_entry4.grid(row=3, column=2, padx=5)
        self.val_uni_entry4 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.val_uni_entry4.grid(row=3, column=3)
        self.val_total_entry4 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.val_total_entry4.grid(row=3, column=4, padx=5)
        self.quant_entry5 = Entry(self.subframe_material1, width=5, relief=RIDGE, state=DISABLED)
        self.quant_entry5.grid(row=4, column=0, padx=5)
        self.id_entry5 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.id_entry5.grid(row=4, column=1)
        self.descr_entry5 = Entry(self.subframe_material1, width=50, relief=RIDGE, state=DISABLED)
        self.descr_entry5.grid(row=4, column=2, padx=5)
        self.val_uni_entry5 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.val_uni_entry5.grid(row=4, column=3)
        self.val_total_entry5 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.val_total_entry5.grid(row=4, column=4, padx=5)
        self.quant_entry6 = Entry(self.subframe_material1, width=5, relief=RIDGE, state=DISABLED)
        self.quant_entry6.grid(row=5, column=0, padx=5)
        self.id_entry6 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.id_entry6.grid(row=5, column=1)
        self.descr_entry6 = Entry(self.subframe_material1, width=50, relief=RIDGE, state=DISABLED)
        self.descr_entry6.grid(row=5, column=2, padx=5)
        self.val_uni_entry6 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.val_uni_entry6.grid(row=5, column=3)
        self.val_total_entry6 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.val_total_entry6.grid(row=5, column=4, padx=5)
        self.quant_entry7 = Entry(self.subframe_material1, width=5, relief=RIDGE, state=DISABLED)
        self.quant_entry7.grid(row=6, column=0, padx=5)
        self.id_entry7 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.id_entry7.grid(row=6, column=1)
        self.descr_entry7 = Entry(self.subframe_material1, width=50, relief=RIDGE, state=DISABLED)
        self.descr_entry7.grid(row=6, column=2, padx=5)
        self.val_uni_entry7 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        self.val_uni_entry7.grid(row=6, column=3)
        self.val_total_entry7 = Entry(self.subframe_material1, width=10, relief=RIDGE, state=DISABLED)
        ...
        self.entry_mao_obra_material = Entry(self.introframe_material2, width=15, state=DISABLED)
        ...
        self.entry_form_pag = Entry(self.introframe_material2, width=15, state=DISABLED)
        ...
        self.entry_total_material = Entry(self.subframe_material3, width=20, fg="red", state=DISABLED)
        ...
        self.alug_id = Label(self.sub_dados_alug, text='', bg=color_orc2, fg="red", font=font_dados_alug2, anchor=W)
        self.alug_id.grid(column=1, row=0, sticky=W, padx=10)
        self.alug_id.configure(width=18)
        self.alug_id.grid_propagate(0)
        self.alug_nome = Label(self.sub_dados_alug, text='', bg=color_orc2, fg="red", font=font_dados_alug2, anchor=W)
        self.alug_nome.grid(column=1, row=1, sticky=W, padx=10)
        self.alug_nome.configure(width=18)
        self.alug_nome.grid_propagate(0)
        self.alug_telefone = Label(self.sub_dados_alug, text='', bg=color_orc2, fg="red", font=font_dados_alug2, anchor=W)
        self.alug_telefone.grid(column=1, row=2, sticky=W, padx=10)
        self.alug_telefone.configure(width=18)
        self.alug_telefone.grid_propagate(0)
        self.alug_apar = Label(self.sub_dados_alug, text='', bg=color_orc2, fg="red", font=font_dados_alug2, anchor=W)
        self.alug_apar.grid(column=1, row=3, sticky=W, padx=10)
        self.alug_apar.configure(width=18)
        self.alug_apar.grid_propagate(0)
        self.alug_marca = Label(self.sub_dados_alug, text='', bg=color_orc2, fg="red", font=font_dados_alug2, anchor=W)
        self.alug_marca.grid(column=1, row=4, sticky=W, padx=10)
        self.alug_marca.configure(width=18)
        self.alug_marca.grid_propagate(0)
        self.alug_modelo = Label(self.sub_dados_alug, text='', bg=color_orc2, fg="red", font=font_dados_alug2, anchor=W)
        self.alug_modelo.grid(column=1, row=5, sticky=W, padx=10)
        self.alug_modelo.configure(width=18)
        self.alug_modelo.grid_propagate(0)
        self.alug_nserie = Label(self.sub_dados_alug, text='', bg=color_orc2, fg="red", font=font_dados_alug2, anchor=W)
        self.alug_nserie.grid(column=1, row=6, sticky=W, padx=10)
        self.alug_nserie.configure(width=18)
        self.alug_nserie.grid_propagate(0)
        self.alug_dias = Label(self.sub_dados_alug, text='', bg=color_orc2, fg="red", font=font_dados_alug2, anchor=W)
        self.alug_dias.grid(column=1, row=7, sticky=W, padx=10)
        self.alug_dias.configure(width=18)
        self.alug_dias.grid_propagate(0)
        self.alug_saida = Label(self.sub_dados_alug, text='', bg=color_orc2, fg="red", font=font_dados_alug2, anchor=W)
        self.alug_saida.grid(column=1, row=8, sticky=W, padx=10)
        self.alug_saida.configure(width=18)
        self.alug_saida.grid_propagate(0)
        self.alug_devol = Label(self.sub_dados_alug, text='', bg=color_orc2, fg="red", font=font_dados_alug2, anchor=W)
        self.alug_devol.grid(column=1, row=9, sticky=W, padx=10)
        self.alug_devol.configure(width=18)
        self.alug_devol.grid_propagate(0)
        self.alug_pag = Label(self.sub_dados_alug, text='', bg=color_orc2, fg="red", font=font_dados_alug2, anchor=W)
        self.alug_pag.grid(column=1, row=10, sticky=W, padx=10)
        self.alug_pag.configure(width=18)
        self.alug_pag.grid_propagate(0)
        ...
        self.alug_coment1 = Entry(self.labelframe_orc_coment, width=140, state=DISABLED)
        self.alug_coment1.pack(padx=5, pady=5)
        self.alug_coment2 = Entry(self.labelframe_orc_coment, width=140, state=DISABLED)
        self.alug_coment2.pack()
        self.alug_coment3 = Entry(self.labelframe_orc_coment, width=140, state=DISABLED)
        self.alug_coment3.pack(pady=5)
        ...
        def EditaAluguel(event):
            self.janelaNovoAluguel(2)
        ...
        self.tree_orc.bind('<Double-1>', EditaAluguel)
    ...
    def janelaConta(self, num, obj):
        ...
        if num == 1:
            ...
            revend = revendedor_repositorio.RevendedorRepositorio().listar_revendedor_id(ultimo_est.revendedor_id,
                                                                                         sessao)
    ...
    def janelaOrçamento(self, jan):
        ...
        Button(labelframe_buttons_material, text="2", width=5, command=tabelaMaoObra).grid(row=0, column=1, ipady=7,
                                                                                           padx=5, pady=5)
        Button(labelframe_buttons_material, text="3", width=5, command=self.abreCalculadora).grid(row=0, column=2,
                                                                                                  ipady=7, padx=5,
                                                                                                  pady=5)
    ...
    def cadastroEstoque(self, op, jan):  # op == 1 entrada de estoque / op == 2 saida de estoque /
        ...
        try:
            ...
            if op == 1 and revendedor is None:
                ...
                if res:
                    novo_estoque = estoque.Estoque(revendedor, obs1, obs2, obs3, nota, frete, op, operador, total,
                                                   produtos,
                                                   data, hora)
                    ...
                    if op == 3:
                        ...
                        self.popularEntradaEstoque()
                        print('Sucesso')
                        res1 = messagebox.askyesno(None,
                                                   "Estoque Inserido com Sucesso! Deseja Criar Conta para esta Entrada?")
                        if res1:
                            jan.destroy()
                ...
                try:
                    ...
                    if op == 2:  # op == 2 editar estoque
                        ...
                        if len(repositorio.listar_vendas(sessao)) == 0:
                            ...
                            id_venda = repositorio.listar_vendas(sessao)[
                                           -1].id_venda + 1  # Pega id da venda que sera feita agora
    ...
    def abreCalculadora(self):
        ...
        button_porcent = Button(frame_buttons, text='%', width=larg_button, height=tam_button, relief=FLAT,
                                bg=bg_janela,
    ...
    def popularAluguel(self):
        ...
        for i in alugueis:
            ...
            self.label_num_alug.config(text=len(alugueis))
    ...
    def janelaNovoAluguel(self, num):
        ...
        def janelaBuscaCliente():
            ...
            def selecionaCliente():
                cliente_selecionado = treeview_busca_cliente.focus()
                dado_cli = treeview_busca_cliente.item(cliente_selecionado, 'values')
                self.cliente_obj = cliente_repositorio.ClienteRepositorio().listar_cliente_id(dado_cli[0], sessao)
            ...
            Button(subframe3, text='Fechar', width=12, command=jan.destroy).grid(row=0, column=3,
                                                                                 ipady=5)
            Button(subframe3, text='Selecionar', command=selecionaCliente, width=12).grid(row=0,
                                                                                          column=1,
                                                                                          ipady=5)
            Button(subframe3, text='Novo', command=self.janelaCadastroCliente, width=12).grid(row=0, column=2,
                                                                                              ipady=5, padx=15)
        ...
        def janelaBuscaequip():
            ...
            def selecionaEquip():
                ...
                maquina_selec = maquina_aluguel_repositorio.MaquinaAluguelRepositorio().listar_equip_id(
                    dado_equip[2], sessao)
                if maquina_selec.status == 'DISPONÍVEL':
                    self.equipamento_obj = maquina_selec
                    ...
                    messagebox.showinfo(title="ERRO",
                                        message=f"Máquina Indisponível para Aluguel! Status: {maquina_selec.status}")
            ...
            Button(subframe2, text='Selecionar', command=selecionaEquip, width=12).pack(padx=10, pady=10, side=RIGHT,
                                                                                        ipady=3)
        ...
        def janelaBuscaAcessorio(num):
            ...
            def selecionaAcess(num):
                equip_selecionado = treeview_busca_acess.focus()
                dado_equip = treeview_busca_acess.item(equip_selecionado, 'values')

                acessorio_selec = acessorio_maquina_aluguel_repositorio.AcessorioMaquinaAluguelRepositorio().listar_equip_id(
                    dado_equip[0], sessao)

                if num == 1:
                    orc_quant_entry1.delete(0, END)
                    orc_quant_entry1.insert(0, 1)
        ...
        subframe_cliente.pack(fill=X)
        Label(subframe_cliente, text='Cliente', bg=bg_tela).grid(row=0, column=0, sticky=W)
        venda_cliente = Entry(subframe_cliente, width=150, textvariable=osVar1, bg=bg_entry, state=DISABLED)
        venda_cliente.grid(row=1, column=0, sticky=W)
        venda_button_busca_cliente = Button(subframe_cliente, text='Buscar',
                                            command=janelaBuscaCliente)
    ...
    def janelaNovaMaqAluguel(self, num):
        ...
        subframe_est_dados1 = LabelFrame(frame_est_dados, text='Dados', bg=layout_Princ, font=('', 9, 'bold'))
        subframe_est_dados1.pack(fill=X, padx=10, ipadx=10, ipady=5, pady=10)
        Label(subframe_est_dados1, text="ID. Máquina", bg=layout_Princ).grid(row=0, column=0, sticky=W, pady=10,
                                                                             padx=10)
        ...
        salvar_button = Button(frame_princ1, text="Salvar(F2)", width=10,
                               command=lambda: [cadastrarMaquinaAluguel(jan, num)])
        salvar_button.pack(side=RIGHT)
        Button(frame_princ1, text="Cancelar", width=10, command=jan.destroy).pack(side=RIGHT, padx=20)
        Button(frame_princ1, text="Alugueis Ant.", width=10, command=self.janelaClonarProduto, state=DISABLED).pack(
            side=LEFT)
    ...
    def atualizaDadosAlug(self):
        ...
        if len(dado_alug)>0:
            ...
            if alug_dados is not None:
                ...
                self.alug_id.config(text=alug_dados.id)
                self.alug_nome.config(text=alug_dados.aluguel_cliente.nome)
                self.alug_telefone.config(text=alug_dados.aluguel_cliente.whats)
                self.alug_apar.config(text=alug_dados.aluguel_equipamento.equipamento)
                self.alug_marca.config(text=alug_dados.aluguel_equipamento.marca)
                self.alug_modelo.config(text=alug_dados.aluguel_equipamento.modelo)
                self.alug_nserie.config(text=alug_dados.aluguel_equipamento.num_serie)
                self.alug_dias.config(text=alug_dados.dias)
                self.alug_saida.config(text=alug_dados.data.strftime('%d/%m/%Y'))
                self.alug_devol.config(text=alug_dados.data_entrega.strftime('%d/%m/%Y'))
                self.alug_pag.config(text=aluga_pago)

                self.alug_coment1.config(state=NORMAL)
                self.alug_coment1.delete(0, END)
                self.alug_coment1.insert(0, alug_dados.obs1)
                self.alug_coment1.config(state=DISABLED)
                self.alug_coment2.config(state=NORMAL)
                self.alug_coment2.delete(0, END)
                self.alug_coment2.insert(0, alug_dados.obs2)
                self.alug_coment2.config(state=DISABLED)
                self.alug_coment3.config(state=NORMAL)
